...
const Contact = () => {
  return (
    <section id="contact" className="py-14 md:py-16 px-4 gradient-hero">
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-10 animate-fade-in">
          ...
          <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto">
            I'm excited to work with teams and professionals who share a vision
            of using data to create meaningful impact.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <Card className="glass border-border/50 hover:border-primary/50 transition-all hover:glow">
            <CardHeader>
              <CardTitle className="text-lg sm:text-xl">Open To</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <p className="flex items-start gap-2 text-sm sm:text-base text-muted-foreground">
              ...
              <p className="flex items-start gap-2 text-sm sm:text-base text-muted-foreground">
                <span className="text-primary">•</span>
                Data analytics or machine learning roles, full-time/contract
                based
              </p>
            </CardContent>
          </Card>
        ...
        <div className="text-center">
          <p className="text-sm sm:text-base text-muted-foreground mb-6">
            If your work thrives on data-driven innovation, I'd love to
